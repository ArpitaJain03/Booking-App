...
export default function PhotosUploader({addedPhotos,onChange}){
    ...
    return(
        ...
        <div className="flex gap-2">
               ...
               <div className="mt-2 gap-2 grid grid-cols-3  md:gird-cols-4 lg:grid-cols-6">
                {addedPhotos.length > 0 && addedPhotos.map(link => (
                    ...
                    <button onClick={ev => selectAsMainPhoto(ev,link)} className="cursor-pointer absolute bottom-1 left-h1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3">
