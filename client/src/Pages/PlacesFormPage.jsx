    ...
    return(
        <div>
            ...
            <form onSubmit={savePlace}>
                ...
                {preInput('Extra Information','House rules, timings...etc')}
                <textarea value={extraInfo} onChange={ev => setExtraInfo(ev.target.value)} />

                {preInput('Check in&out time','Add checkin and checkout time, remember to have some time window for cleaning the room between guests')}
